...
public class MasterElement extends Element
{
  ...
  public Element readNextChild(final EBMLReader reader)
  {
    ...
    {
      //THEOLOG.trace("Can't read any more children");
      return null;
    }
    ...
    if (elem == null)
    {
      //THEOLOG.debug("Reader returned null");
      return null;
    }
    ...
    //THEOLOG.trace("Read element {} of size {}: {} remaining", elem.typeInfo.getName(), elem.getTotalSize(), size - usedSize);
    return elem;
  }
