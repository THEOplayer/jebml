...
{
  //THEOprivate static final Logger LOG = LoggerFactory.getLogger(MatroskaFileFrame.class);
  ...
  {
    //THEOLOG.trace("Setting data with size {}", data.remaining());
    this.data = data; //this.data = data.duplicate(); THEO_ replaced
  }
