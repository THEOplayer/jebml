...
public class MatroskaFile
{
  ...
  //THEOprotected static final Logger LOG = LoggerFactory.getLogger(MatroskaFile.class);
  ...
  public void readFile()
  {
    ...
    {
      level1 = ((MasterElement) level0).readNextChild(reader);
      //THEOLOG.debug("Got segment element");
      while (level1 != null)
      {
        //THEOLOG.debug("Got {} element in segment", level1.getElementType().getName());
