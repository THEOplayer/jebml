...
{
  //THEOprivate static final Logger LOG = LoggerFactory.getLogger(MatroskaFileWriter.class);
  ...
  public void flush()
  {
    ...
    //THEOLOG.debug("Cluster flushing, timecode {}", cluster.getClusterTimecode());
    cluster.flush(ioDW);
  }
