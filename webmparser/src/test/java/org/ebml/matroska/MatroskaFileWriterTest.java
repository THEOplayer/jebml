...
{
  //THEOprivate static final Logger LOG = LoggerFactory.getLogger(MatroskaFileWriterTest.class);
  ...
  private void traverseElement(final Element levelN, final DataSource ioDS, final EBMLReader reader, final int level)
  {
    ...
    //THEOLOG.info("Found element {} at level {}", levelN.getElementType().getName(), level);
