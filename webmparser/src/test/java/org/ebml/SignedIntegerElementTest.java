...
public class SignedIntegerElementTest
{
  ...
  //THEOprivate static final Logger LOG = LoggerFactory.getLogger(UnsignedIntegerElementTest.class);
  ...
  public void testPositiveData()
  {
    for (int i = 0; i < 8; ++i)
    {
      ...
      //THEOLOG.debug("Testing {} for {}", value, i);
      elem.setValue(value);
  ...
  public void testPositiveElement()
  {
    for (int i = 0; i < 8; ++i)
    {
      ...
      //THEOLOG.debug("Testing element {} val {} ({})", i, value, size);
